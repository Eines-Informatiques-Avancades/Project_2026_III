...
contains
    ...
    function LJ_energy(coord) result(E)
        ...
        real(8) :: E, r2, sigma2, sigma6, sigma12, epsil_4
        ...
        do i = 1, n_atoms-4
            ...
            r2 = dx*dx + dy*dy + dz*dz
                if (r2 < r_cut2) then ! Exclude 1-2 1-3 and 1-4 interactions
                    r2_inv = 1.0d0 / r2
                    r6_inv = r2_inv*r2_inv*r2_inv

                    E = E + epsil_4 * (sigma12 * r6_inv**2 - sigma6 * r6_inv)
                    k = k + 1
                end if
            end do
        end do
    ...
    !It calculates the total energy (LJ + dihedral) for a given set of coordinates and dihedral angles
